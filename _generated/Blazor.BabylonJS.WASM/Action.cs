...
namespace BABYLON
{
    ...
    public class Action : CachedEntityObject, IAction
    {
        ...
        public Observable<Action> onBeforeExecuteObservable
        {
            ...
            {
                __onBeforeExecuteObservable = EventHorizonBlazorInterop.GetClass<Observable<Action>>(
                    this.___guid,
...
__onBeforeExecuteObservable = null;
        ...
        public Action(
            object triggerOptions, Condition condition = null
        ) : base()
        {
        ...
        public void skipToNextActiveAction()
        {
            EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
                    new string[] { this.___guid, "skipToNextActiveAction" }
                }
            );
        }
