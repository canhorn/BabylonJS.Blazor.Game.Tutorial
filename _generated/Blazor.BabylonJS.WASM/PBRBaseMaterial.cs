    ...
    public class PBRBaseMaterial : PushMaterial
    {
        ...
        public bool isMetallicWorkflow()
        {
            return EventHorizonBlazorInterop.Func<bool>(
                new object[]
                {
                    new string[] { this.___guid, "isMetallicWorkflow" }
                }
            );
        }

        public void forceCompilation(AbstractMesh mesh, ActionCallback<Material> onCompiled = null, IMaterialCompilationOptions options = null)
        {
            EventHorizonBlazorInterop.Func<CachedEntity>(
                new object[]
                {
                    new string[] { this.___guid, "forceCompilation" }, mesh, onCompiled, options
                }
            );
        }
